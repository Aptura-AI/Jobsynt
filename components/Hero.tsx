      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-16 lg:flex-row lg:items-center">
        <div className="flex-1 space-y-6">
          ...
          <h1 className="text-4xl font-bold leading-tight text-ink sm:text-5xl">
            Your AI-Powered Talent Marketplace for ERP, Cloud & IT Professionals
          </h1>
          <p className="text-lg text-muted">
            Find vetted specialists or showcase your expertise. Jobsynt connects enterprises with niche ERP, cloud & IT talent, faster.
          </p>
          ...
          <div className="flex flex-wrap gap-4 text-sm text-muted">
            <span className="flex items-center gap-2 rounded-md bg-white px-3 py-2 shadow-sm">✅ Vetted ERP experts</span>
        ...
        <div className="flex-1">
          <div className="card p-6">
            <h3 className="mb-4 text-lg font-semibold text-ink">Trusted by ERP & Cloud teams</h3>
            <div className="grid grid-cols-2 gap-3 text-sm text-muted">
              <div className="rounded-md bg-surface p-3 shadow-inner">
                ...
                <ul className="mt-2 list-disc space-y-1 pl-4">
                  <li>ERP Systems (SAP, Oracle, etc.)</li>
                  <li>Cloud Architects</li>
                  <li>IT Specialists & DBAs</li>
                </ul>
              </div>
              <div className="rounded-md bg-surface p-3 shadow-inner">
